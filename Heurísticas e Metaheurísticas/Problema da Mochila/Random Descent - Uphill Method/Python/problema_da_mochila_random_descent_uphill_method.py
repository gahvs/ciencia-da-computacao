...
Nesta solução, um vizinho aleatório da solução é analisado e o mesmo é aceito apenas se for estri-
tamente melhor que a solução corrente, não o sendo a solução permanece a mesma e outro vizinho 
aleatório é testado. Esse procedimento é interrompido após um número fixo pré-definido de itera-
ções sem melhoria na solução.
...
def main():
    ...
    print("\n\nProblema da Mochila - Random Descent-Uphill Method\n\n")
